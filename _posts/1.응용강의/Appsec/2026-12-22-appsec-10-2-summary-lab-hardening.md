...
> 이 과정의 **마지막 실습** 입니다. 지금까지 배운 방어를 **Ubuntu(192.168.56.30)** 한 서버에 모아 **하드닝(보안 강화) 점검** 으로 마무리합니다.
{: .prompt-info }
...
| **TLS 버전**(06) | `testssl.sh 192.168.56.30:443` | TLS1.2+ |
