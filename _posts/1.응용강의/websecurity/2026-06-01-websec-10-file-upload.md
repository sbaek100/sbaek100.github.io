...
| 2012~ | **China Chopper**[^c10_chinachopper] | 초소형 웹셸. 탐지 회피·지속성에 강해 국가배후 공격에 광범위 사용 |
| 2021 | **MS Exchange (ProxyLogon/ProxyShell)**[^c10_proxylogon] | 초기 침투 후 **웹셸을 업로드해 지속성 확보** — 전 세계 수만 대 서버에 웹셸이 심어짐. "업로드/드롭된 웹셸"이 침해의 핵심 |
...
본문의 웹셸·사건은 아래 출처에 근거합니다(각주 번호를 클릭하면 이동).

**더 읽어보기**

- OWASP File Upload Cheat Sheet — <https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html>

[^c10_chinachopper]: China Chopper 웹셸 분석(~4KB, APT 광범위 사용). Mandiant/Google Cloud Threat Intelligence. <https://cloud.google.com/blog/topics/threat-intelligence/breaking-down-china-chopper-web-shell-part-i>
[^c10_proxylogon]: MS Exchange ProxyLogon(2021) — 침투 후 웹셸 드롭, CVE-2021-26855 체인. NVD. <https://nvd.nist.gov/vuln/detail/CVE-2021-26855>
