---
title: "[AI 보안 자동화 Lab] 08-01. 스캔 결과를 표로 — 발견 항목과 CWE/CVE 컬럼"
date: 2026-11-22 09:00:00 +0900
categories:
  - 1.응용강의
  - AI자동화
tags:
...
target = st.text_input("점검할 대상 주소", value="192.168.57.30")
...
화면에 이렇게 보입니다. **[점검 시작]**을 누르면 잠깐 "점검 중..." 스피너가 돌고, 곧 초록색 **"✅ 192.168.57.30 점검 완료 — 5건 발견"** 메시지가 뜹니다. 아직 표는 안 나옵니다(다음 단계에서 그립니다). 하지만 결과는 **서랍(`session_state`)에 안전하게 들어간** 상태입니다.
