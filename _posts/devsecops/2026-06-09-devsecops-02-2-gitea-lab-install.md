...
대상 VM: **build (192.168.56.10)**. 01-3에서 켜 둔 상태로 진행합니다.
...
| 서버 도메인 | `192.168.56.10` |
| Gitea 기본 URL | `http://192.168.56.10:3000/` |
| SSH 서버 도메인 | `192.168.56.10` |
...
이제 `http://192.168.56.10:3000/devops/myapp` 저장소가 생겼습니다.
...
```bash
cd ~
git clone http://192.168.56.10:3000/devops/myapp.git
cd myapp
```
