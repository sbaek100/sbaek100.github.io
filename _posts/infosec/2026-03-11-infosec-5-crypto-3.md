---
title: (5주차 확장) 현대 암호 #2 - 공개키 암호체계, 무결성, 전자서명
...
#### **키 배송 문제(Key Distribution Problem) 를 해결**
- ▪ 공개채널에서도 안전하게 공통 키 생성 가능
- ▪ 공개키 암호학의 시작점
- ▪ 인터넷 보안의 기초 초대 마련
- ▪ 두 사람이 만난 적 없어도 비밀을 공유할
- 수 있다!
...
PDF 후반부는 GPG4Win 기반의 실습 절차를 안내한다.
...
아래 내용은 정보보안 산업기사에서 자주 묻는 개념 비교형/서술형 문제에 맞춰 보강한 파트다.

1. 공개키와 대칭키를 속도, 키관리, 사용목적 축으로 설명할 수 있어야 한다.
2. RSA는 수학 원리뿐 아니라 패딩(OAEP/PSS), 키 길이, 난수 품질까지 함께 이해해야 한다.
3. MAC/HMAC와 전자서명의 차이는 부인방지 가능 여부로 구분할 수 있어야 한다.
4. 인증서 검증은 필드 확인 + 체인 검증 + 폐기 확인(CRL/OCSP)까지 묶어서 설명해야 한다.
5. DH는 DHE/ECDHE, PFS(Forward Secrecy)까지 연결해서 이해해야 한다.

---

## 12. 대칭키 vs 공개키: 시험형 비교표
