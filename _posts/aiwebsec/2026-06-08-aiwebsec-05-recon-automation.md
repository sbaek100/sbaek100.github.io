...
> **🎯 우리가 지금 왜 이걸 하나요?**  
> 낯선 건물에 들어가기 전에 먼저 **출입구가 몇 개고 어디에 있는지** 살펴보잖아요. 보안 점검도 똑같아요. 무엇을 어떻게 점검할지 정하려면, 먼저 **"무엇이 거기 있는지"**부터 알아야 해요. 이 단계를 정찰(Reconnaissance)이라고 불러요. 이번 강의에서는 AI가 여러 도구를 스스로 골라 가며 대상의 **지도**를 그리게 만들 거예요.
{: .prompt-info }
