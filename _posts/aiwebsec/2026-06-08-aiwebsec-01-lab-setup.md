...
> **🎯 우리가 지금 왜 이걸 하나요?**  
> 멋진 AI 점검 도구를 만들려면, 먼저 그 도구가 돌아갈 **작업대**가 필요해요. 요리로 치면 칼을 들기 전에 도마와 재료부터 챙기는 단계예요. 지금 환경을 제대로 갖춰 두면 다음 강의부터 코드가 막힘없이 돌아가고, 반대로 여기서 대충 넘어가면 나중에 작은 오류 하나로 한참 헤매게 돼요. 그래서 지루해 보여도 꼭 필요한 단계랍니다.
{: .prompt-info }
