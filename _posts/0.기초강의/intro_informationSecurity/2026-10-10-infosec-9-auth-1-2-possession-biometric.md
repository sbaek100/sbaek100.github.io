...
> **📜 역사 한 토막 — OTP 회사가 해킹당하면: RSA SecurID 사건(2011)**
>
> 2011년 3월, OTP 토큰의 대명사이던 보안 회사 RSA가 뚫렸다. 시작은 **"2011년 채용 계획.xls"라는 제목의 피싱 메일 한 통** — 직원이 스팸함에서 꺼내 열어본 첨부 파일의 제로데이 취약점으로 내부망이 장악됐고, SecurID 토큰의 **시드(seed) 관련 정보**가 유출되었다. 두 달 뒤 이 정보는 방산업체 록히드마틴 침입 시도에 실제로 사용되었고, RSA는 결국 **전 세계 토큰 수천만 개를 교체**했다.
>
> 교훈은 두 가지다. 소유 기반 인증의 안전은 토큰이라는 물건이 아니라 **그 안의 비밀(시드)** 에 달려 있으며, 그 비밀을 보관하는 서버가 급소라는 것. 그리고 아무리 강한 인증 기술도 **피싱 메일 한 통(사람)** 으로 우회될 수 있다는 것.
>
> *근거: RSA(EMC)의 고객 공개 서한(2011.3); 록히드마틴 발표(2011.5); EMC 분기 실적 발표 — 대응 비용 6,600만 달러.*
{: .prompt-tip }
...
> **📜 역사 한 토막 — 기자회견 사진으로 복제된 장관의 지문(2014)**
>
> 2014년 말 독일의 해커 컨퍼런스 CCC에서, 해커 얀 크리슬러(별명 Starbug)는 독일 국방장관의 지문을 재현해 보였다. 사용한 재료는 **기자회견에서 찍힌 손 사진 몇 장**과 시판 지문 분석 소프트웨어가 전부였다 — 장관을 만난 적도, 장관이 만진 물건을 얻은 적도 없다. 앞서 2013년에는 같은 단체가 아이폰의 지문 인식(Touch ID)을 **출시 이틀 만에** 젤라틴 지문으로 우회하기도 했다.
>
> 이 시연이 남긴 문장은 생체인증의 본질을 꿰뚫는다. **"생체정보는 바꿀 수 없는 비밀번호다."** 유출된 패스워드는 바꾸면 되고 도난된 토큰은 재발급하면 되지만, 지문과 홍채는 폐기도 재발급도 불가능하다(→ 3.4 결론의 문제의식). 게다가 생체정보는 비밀도 아니다 — 우리는 매일 지문을 온 세상에 묻히고 얼굴을 공개하며 다닌다.
>
> *근거: J. Krissler의 CCC 31C3 발표(2014.12); CCC의 Touch ID 우회 시연 발표(2013.9).*
{: .prompt-tip }
