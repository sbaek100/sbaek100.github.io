...
graph TD
    ...
    A --> C[문자형]
    A --> D[날짜 및 시간형]
    B --> B1["정수형<br/>TINYINT<br/>SMALLINT<br/>INT<br/>BIGINT"]
    B --> B2["실수형<br/>FLOAT<br/>DOUBLE<br/>DECIMAL"]
    C --> C1["고정길이<br/>CHAR"]
    C --> C2["가변길이<br/>VARCHAR"]
    C --> C3["장문<br/>TEXT / BLOB"]
    C --> C4["선택형<br/>ENUM"]
    D --> D1["DATE<br/>TIME<br/>DATETIME<br/>YEAR"]
```
...
외래키 값은 참조하는 테이블의 기본키에 **실제로 존재하는 값**이어야 함.
